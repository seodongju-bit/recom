...
<table class="notice_view">              
		...
		<tbody>             
		<c:set var="notice2" value="${resultMap}" />
			<tr>
				<th scope="row">신고번호</th>
				<td>${notice2.DE_NUMBER}</td>
				<th scope="row">신고분류</th>
				<td>${notice2.DE_DIVISION}</td>
			</tr>
			<tr>
				
				<th scope="row">신고일자</th>
				<td>${notice2.DE_DATE}</td>                               
			</tr>
			<tr>
				<th scope="row">신고자</th>
				<td colspan="3">${notice2.MEM_ID}님</td>
			</tr>
			<tr>                                         
				<td colspan="4" id="contents">${notice2.DE_CONTENTS}</td>
			</tr>
